...
const Orders = () => {
    ...
    <Document>
      <Page>
        <View style={styles.header}>
          <Text style={styles.headerText}>Order Reports</Text>
        </View>
          ...
          {orders &&
            orders.map((order) => (
              <View style={styles.tableRow} key={order.id}>
                ...
                <Text style={styles.tableCell}>{order.cart.length}</Text>
                <Text style={styles.tableCell}>Rp. {order.totalPrice}</Text>
              </View>
            ))}
        </View>
      </Page>
  ...
  const handleDownloadPDF = () => (
    <PDFDownloadLink document={<MyDocument />} fileName="orders.pdf">
